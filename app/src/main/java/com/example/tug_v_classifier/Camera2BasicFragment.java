...
public class Camera2BasicFragment extends Fragment
    ...
    private void getFinalResult(){
        ...
        for(int i=0; i<results.size();i++){
            if(results.get(i).equals("cata")){
                a.add(results.get(i));
            }
            if(results.get(i).equals("catb")){
                b.add(results.get(i));
            }
            if(results.get(i).equals("catc")){
                c.add(results.get(i));
            }
            if(results.get(i).equals("catd")){
                d.add(results.get(i));
            }
            if(results.get(i).equals("cate")){
                e.add(results.get(i));
            }
        }
        ArrayList<String> biggest;
        biggest=a;
        if(b.size()>biggest.size()){
            biggest=b;
        }
        else if(c.size()>biggest.size()){
            biggest=c;
        }
        else if(d.size()>biggest.size()){
            biggest=d;
        }
        else if(e.size()>biggest.size()){
            biggest=e;
        }
        else{
            finalResult = "Inconclusive";
